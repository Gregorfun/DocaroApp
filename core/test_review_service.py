...
def test_build_final_filename_sanitization():
    ...
    extraction = {
        "supplier_canonical": "Test/Firma: GmbH",
        "date": "2025-01-15",
        "doc_number": "RE*2025?123"
    }
...
def test_build_final_filename_remove_scan_prefix():
    ...
    extraction = {
        "supplier_canonical": "scan_Musterfirma GmbH",
        "date": "2025-01-15",
        "doc_number": "scan RE-123"
    }
...
def test_save_correction(tmp_path):
    """Test: Correction wird in corrections.json gespeichert."""
