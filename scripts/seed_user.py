...
from services.auth_store import create_user, init_auth_db, set_user_password
...
def main() -> int:
    ...
    if args.reset_password:
        ...
        user = updated or create_user(db_path, args.email, password)
    else:
        user = create_user(db_path, args.email, password)
