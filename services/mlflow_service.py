...
class MLflowService:
    ...
    **Nutzen**:
    ...
    def __init__(self, tracking_uri: str = None, experiment_name: str = "docaro_ml"):
        """
        Args:
    ...
    def _get_mlflow(self):
        ...
        try:
            ...
            raise ImportError("MLflow ist nicht installiert. " "Installiere mit: pip install mlflow")
    ...
    def log_model(self, model, artifact_path: str, registered_model_name: Optional[str] = None):
        ...
        **Beispiel**:
        ...
        if hasattr(model, "fit") and hasattr(model, "predict"):
            ...
            mlflow.pyfunc.log_model(artifact_path, python_model=model, registered_model_name=registered_model_name)

    def load_model(self, model_name: str, version: Optional[str] = "latest"):
        """
    ...
    def search_runs(self, filter_string: Optional[str] = None, order_by: Optional[str] = None, max_results: int = 100):
        """
...
def train_supplier_classifier_example():
    ...
    # Hyperparameter
    params = {"n_estimators": 200, "max_depth": 20, "min_samples_split": 5, "random_state": 42}
    ...
    with mlflow_service.start_run("supplier_rf_v1", tags={"algorithm": "random_forest"}):
        ...
        mlflow_service.log_metrics(
            {"accuracy": accuracy, "f1_score": f1, "train_samples": len(X_train), "test_samples": len(X_test)}
        )

        # Logge Modell
        mlflow_service.log_model(model, artifact_path="model", registered_model_name="supplier_classifier")

        print("✅ Training abgeschlossen:")
        print(f"   Accuracy: {accuracy:.3f}")
        print(f"   F1-Score: {f1:.3f}")
        print("   Modell registriert: supplier_classifier")
